...
library Gas {
    ...
    uint128 constant REGISTER_DOMAIN_VALUE      = 1 ever;  // more than DEPLOY_DOMAIN_VALUE
    uint128 constant RENEW_DOMAIN_VALUE         = 1 ever;  // more than UPGRADE_SLAVE_VALUE + RETURN_TOKENS_VALUE
    ...
    uint128 constant DEPLOY_DOMAIN_VALUE        = 0.8 ever;  // more than DOMAIN_TARGET_BALANCE + 2 * DEPLOY_INDEX_VALUE[TIP4.3]
    uint128 constant CONFISCATE_VALUE           = 1 ever;
    uint128 constant UNRESERVE_VALUE            = 1 ever;
    uint128 constant UPGRADE_SLAVE_VALUE        = 0.8 ever;

    // Certificate
    uint128 constant AFTER_CODE_UPGRADE_VALUE   = 0.2 ever;
    uint128 constant DEPLOY_SUBDOMAIN_VALUE     = 0.8 ever;  // more than SUBDOMAIN_TARGET_BALANCE + CREATOR_NOTIFY_VALUE + 2 * DEPLOY_INDEX_VALUE[TIP4.3]
    uint128 constant RENEW_SUBDOMAIN_VALUE      = 0.5 ever;
    //uint128 constant DEPLOY_PRIMARY_VALUE          = 0.8 ever;  // same as DEPLOY_SUBDOMAIN_VALUE
    
    // NFT Certificate
    uint128 constant ON_BURN_VALUE              = 0.2 ever;

    // Domain
    uint128 constant DOMAIN_TARGET_BALANCE      = 0.1 ever;
    ...
    // Subdomain
    uint128 constant SUBDOMAIN_TARGET_BALANCE   = 0.1 ever;
    uint128 constant CREATOR_NOTIFY_VALUE       = 0.1 ever;
